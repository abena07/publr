...
| # | issue |
|---|-------|
| [#5](https://github.com/abena07/publr/issues/5) | Google Drive folder watcher |
| [#6](https://github.com/abena07/publr/issues/6) | Cloudflare R2 storage upload |
| [#7](https://github.com/abena07/publr/issues/7) | Instagram publisher |
| [#8](https://github.com/abena07/publr/issues/8) | main processing pipeline |
| [#9](https://github.com/abena07/publr/issues/9) | frontend snippets |
| [#10](https://github.com/abena07/publr/issues/10) | production deployment |
| [#11](https://github.com/abena07/publr/issues/11) | VSCO (backlog) |
